...
export async function getRecipeDataFromDefaultSchema(json: any, url: string) {
    ...
    return {
        ...
        cookingTime: json.cookTime ? parseISODuration(json.cookTime) : (json.totalTime ? (json.waitingTime ? (parseISODuration(json.totalTime) || 0) - (parseISODuration(json.waitingTime) || 0) : parseISODuration(json.totalTime)) : undefined),
        waitingTime: json.waitingTime ? parseISODuration(json.waitingTime) : (json.totalTime ? (json.cookTime ? (parseISODuration(json.totalTime) || 0) - (parseISODuration(json.cookTime) || 0) : undefined) : undefined),
